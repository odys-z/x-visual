...
export default function XOrbitControls ( object, domElement ) {
	if ( domElement === undefined )
		console.warn( 'X.OrbitControls: The second parameter "domElement" is now mandatory.' );
	if ( domElement === document )
		console.error( 'X.OrbitControls: "document" should not be used as the target "domElement". Please use "renderer.domElement" instead.' );
	...
	this.update = function () {
		...
		return function update() {
			// console.log( ' orbit-control update' );
