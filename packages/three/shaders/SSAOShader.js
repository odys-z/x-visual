...
var SSAOShader = {
  ...
  void main() {
	...
	fragmentShader: `#define KERNEL_SIZE 32
  ...
  float getDepth( const in vec2 screenPosition ) {` +
	/* Three.js doc:
	 * DepthTexture type -- Default is THREE.UnsignedShortType when unsing DepthFormat
	 * DepthFormat reads each element as a single depth value, converts it to
	 * floating point, and clamps to the range [0,1]. This is the default for DepthTexture.
	 */
