...
import {Occluder, FlowingPath, GlowingEdge, Filming} from './component/ext/effects'
...
// export * from './sys/xsys'
export {LayerFilter, Layers} from './xmath/layer'
export {XSys};
...
export const XComponent = {
	...
	AnimType, ModelSeqs,
	FlowingPath, GlowingEdge, Filming, Occluder,
}
