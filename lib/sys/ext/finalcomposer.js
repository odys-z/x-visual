...
import {ShaderMaterial} from '../../../packages/three/three.module-MRTSupport';
	...
	effects(x) {
		...
		var finalPass = new ShaderPass(
			...
			new ShaderMaterial( {
				...
				fragmentShader: finalFrag(x.options.alphaTest || '0.2'),
				defines: new Object() } ),
			"texScene");
...
const finalFrag = (alphaTest) => `${debug ? '// r120-final composer frag' : ''}
