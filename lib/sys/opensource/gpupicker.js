...
//  *
//  * Design Memo: GPU picker is not a system, but only an Input helper.
//  */
...
//
// 	initMyPickings(me, x) {
// 		var scn = me.scene; // picking scene
//
// 		// create meshes
// 		var pickables = x.ecs.queryEntities({has});
// 		if (pickables) {
...
// 				});
//
// 				const picking = new THREE.Mesh( p.GpuPickable.geom,
// 									pickingMaterial);
//
// 				scn.add(picking);
