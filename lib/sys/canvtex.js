	...
	update(tick, entities) {
		...
		for (const e of entities) {
			if (e.Dynatex && e.Dynatex.dirty) {
				if (e.Visual.ShaderFlag !== ShaderFlag.colorArray
					|| !e.Obj3.mesh.material.uniforms
					|| !e.Obj3.mesh.material.uniforms.u_tex
					|| !e.Obj3.mesh.material.uniforms.u_tex.length)
					console.error('Dyantex needs a proper shader to update texture. e = ', e);
				else {
					...
					e.Obj3.mesh.material.uniforms.u_tex = tex;
				}
			}
