...
export default class CanvTex extends XSys {
	...
	init(x, entities) {
		...
		for (const e of entities) {
			var {mesh, vparas} = createTextPlane( e.Obj3, e.Visual, e.Dynatex, x.light, x.ecs );
			if (e.Obj3.mesh)
		...
		function createTextPlane( obj3, visual, dynatex, light, ecs ) {
			var uniforms = GlUniform.init(visual, obj3, light, ecs);
