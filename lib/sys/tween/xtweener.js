...
export default class XTweener extends ECS.System {
	constructor (ecs, x) {
		...
		const entities = ecs.queryEntities({iffall: iffTween});
	...
	initTweens(ecs, entities) {
		if (entities)
			forEach(function(e, i) {
				if (!e.CmpTween._easingFunction)
					e.CmpTween._easingFunction = TWEEN.Easing.Linear.None;
				if (!e.CmpTween._interpolationFunction)
					e.CmpTween._interpolationFunction = TWEEN.Interpolation.Linear;
			});
	}
