...
class MorphingAnim extends ECS.System {
						...
						for (var twnx = seq.length - 1; twnx >= 0; twnx--) {
							...
							// }
								...
								if (!e.Obj3.mesh || !e.ModelSeqs.cache
									...
									points = createFlowingPoints(path, e.FlowingPath.paras);

									// TODO any idea? - take accound of many path points and many particle points to tweened
									// TODO any idea?
									// TODO any idea?
									// TODO any idea?
									// TODO any idea?
	...
	static createFlowingPoints(cmpObj3, paras) {
		if (cmpObj3) {
			// TODO any idea? - take accound of many path points and many particle points to tweened
			// TODO any idea?
			// TODO any idea?
