...
export default class Thrender extends ECS.System {
	...
	static createObj3particles(cmpObj3, fromesh, cmpVisual) {
		...
		// // 			.setUsage( THREE.DynamicDrawUsage ) );
		var destEnt = ecs.getEntity(cmpVisual.paras.dest || cmpVisual.paras.a_dest);
		var geometry = xglsl.particlesGeom(cmpVisual.shader, cmpVisual.paras,
							m0, destEnt ? destEnt.Obj3.mesh : undefined);
