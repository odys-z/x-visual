...
export default class Thrender extends ECS.System {
				...
				switch (e.Visual.vtype) {
					...
					case AssetType.mesh:
						...
						if (!e.Visual.material) {
							// FIXME materail should handled in orthogonal fashion.
					...
					case AssetType.DynaSects:
						var {group, p} = Thrender.createDynaSegments(e.Obj3, e.Visual.paras);
						e.Obj3.mesh = group;
						if (e.ModelSeqs) {
	...
	/**Handling {@link AssetType.GeomCurve}, generate curve of
	 * type of HILBERT, RandomCurve, RandomSects, PointSect,
     * CatmullRom, Spline from {@link XComponent.Obj3Type}.
	 *
	 ...
	 * type of RandomSects, PointSect from {@link XComponent.Obj3Type}.
	 *
	 * 1. use {@link xgeom.generateSegments} to generate lines
	 * 2. create the THREE.line,
	 * 3. set line to Obj3.mesh
	 * @param {Obj3} cmpObj3
	 * @param {object} paras Visual.paras, @see xgeom.generateCurve
	 * @return {object} {curve, path}
	 * @member Thrender.createDynaSegments
	 * @function
	 */
	static createDynaSegments(cmpObj3, paras) {
		var {geoms, points} = xgeom.generateSegments(cmpObj3, paras);
