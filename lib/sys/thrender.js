...
export default class Thrender extends ECS.System {
			...
			if (e.Visual.vtype === AssetType.gltf) {
				...
				switch (e.Visual.vtype) {
					case AssetType.canvas:
						...
						m.visible = false;// until html canvas texture is ready
						mes.push(m);
						break;
					case AssetType.mesh:
					...
					case AssetType.geomCurve:
						...
						if (e.ModelSeqs) {
							...
							// FIXME what's the better practice for this in ECS pattern?
	 ...
	 * to Obj3.geomType ([Obj3Type]{@link Obj3Type}) and Obj3.box.
	...
	/**UPDATING: geometry parameters: design-memo/obj3.rst
	 * @param {Obj3Type} geomType
	 * @param {array<number>} geomParaArr
	 * geomType: geomParaArr
	 * Obj3Type.BOX:<br>
	 *          width, height, depth<br>
	 * Obj3Type.Cylinder:<br>
	...
	/**
	 * Create particles (THREE.Points) from vertices of mesh (frommesh).
