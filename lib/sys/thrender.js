...
import {AssetType, ShaderType} from '../component/visual';
...
export default class Thrender extends ECS.System {
	...
	static createObj3particles(cmpObj3, fromesh, cmpVisual) {
		...
		var material;
		if (cmpVisual.shader === ShaderType.randomParticle) {
			uniforms = {
			...
			Object.assign(uniforms, Thrender.toUniforms(cmpObj3.uniforms));
		...
		geometry.setAttribute( 'position', new THREE.Float32BufferAttribute( m0.clone(), 3 ) );
