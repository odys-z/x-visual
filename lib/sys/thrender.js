...
export default class Thrender extends ECS.System {
		...
		entities.forEach(function(e, x) {
			...
			switch (e.Visual.vtype) {
				...
				case AssetType.mesh_basic:
					...
					var m = Thrender.createObj3mesh(e.Obj3, e.Obj3.geom, mat,
									e.Visual); // FIXME object geometry handling using Viusal.paras
					addObj3(scene, m, e);
					break;
				...
				case AssetType.PathTube:
					...
					break;
				// case AssetType.MapXZRoad:
				// 	// One problem a time, could this be the correct way to be orthogonal?
				// 	// 1. geometry
				// 	// 2. paras & transform
				// 	// 3. material (uniforms for tween)
				// 	// 4. mesh | line | points (with matrix for tween)
	 ...
	 * @function
	 */
	static threeGeometryCase(geomType, geomParaArr, vparas) {
		...
		if (geomType === Obj3Type.BOX) {
			...
			g = xgeom.generateWayxz( vparas.features,
