...
export default class Thrender extends ECS.System {
	...
	static geometryCase(geomType, geomParaArr, vparas, obj3) {
		...
		if (geomType === Obj3Type.BOX) {
			...
			if (vparas && vparas.features) {
				var {geom, path} = AssetKeepr.geoHexacylinder( vparas.features,
										{ radius: vparas.radius,
										  height: vparas.height,
										  geoScale: vparas.scale || vparas.style ? vparas.style.geoScale || 1 : 1,
