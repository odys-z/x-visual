...
export default class Thrender extends ECS.System {
	/**The three.js scene warpper, responsible for creating meshes, loading
	 * assets models, etc.
	 * @param {ECS} ecs
	 * @param {x} x {options, ...}
	...
	static createObj3s(ecs, scene, entities) {
		...
		entities.forEach(function(e, x) {
			var tex, mat;
			var uniforms = Object.assign(new Object(), e.Obj3.uniforms);
	 ...
	 * @member Thrender.createPathTube
	 * @function
	 */
