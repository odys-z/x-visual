...
/**
 * @property {array} iffall - query condition: {iffall: ['Textag', 'Obj3']}
 * @member Textag#iffall
 */
const iffall = ['Textag', 'Obj3'];
 ...
 */
export default class Textag extends XSys {
	/**
	 * @param {ECS} ecs
	 * @param {x} x {options, ...}
	 * @constructor Textag
	...
	constructor (ecs, x) {
		...
		this.refresh = true;
		this.ecs = ecs;
		ecs.registerComponent('Svgtag', Svgtag);
	}
