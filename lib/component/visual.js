...
const Dynatex = {
  properties: {
	...
	dirty: true,
	/**@member Dynatex#xywh
	 * @property {Object} xywh - {x, y, size = 32}, where size are the font size.
	 * @memberof XComponent */
    xywh: undefined,
	 ...
	 * @property {string='blue'} bg-color - text back ground color, defualt 'blue'
	 * @memberof XComponent */
    'bg-color': undefined,

    /**@member Dynatex#v-align
	 * @property {string='top'} v-align - vertical align, only top||middle|bottom|number(parent y)
     */
    'v-align': undefined,

	/**@member Dynatex#hue
	 * @property {array=[0, 0, 0]} hue - default difuse color, 0 ~ 1
	 * @memberof XComponent */
    hue: [0, 0, 0],

	/**@member Dynatex#hueWeight
	 * @property {number=1} texWeight - default text color weigth, 0 ~ 1
	 * @memberof XComponent */
    texWeight: 1,

	/**
	 * @member Dynatex#u_tex
	 * @property {array} u_tex - for text background, etc. Same as Visaul.paras.u_tex
	 * @memberof XComponent */
	u_tex: undefined,
	 ...
	 * @member Dynatex#textmesh - plane of text canvas
	 * @memberof XComponent */
    textplane: undefined
  }
}
