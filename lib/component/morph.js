...
const AnimType = {
	...
	U_PATH_MORPH_Dir: ANIMTYPE_0 + 13 | AnimCate.COMBINE_AFFINE,
	/** ?? */
	WIREFAME: ANIMTYPE_0 + 14,
	/** <b>DEPRECATED</b><br>
	 * replaced by ROTAXIS, used for affines + non-affine combination testing */
	ROTATEX: ANIMTYPE_0 + 15 | AnimCate.COMBINE_AFFINE,
	/** Rotate around axis */
	ROTAXIS: ANIMTYPE_0 + 16 | AnimCate.COMBINE_AFFINE,
	/** Orbit around pivot */
	ORBIT: ANIMTYPE_0 + 17 | AnimCate.COMBINE_AFFINE,
	/** Move alone path */
	PATH_MOVE: ANIMTYPE_0 + 18,
	/** Shader material with color changing */
	SHADER_COLOR: ANIMTYPE_0 + 19,
	/** Extending */
	TODO: ANIMTYPE_0 + 32,
};
