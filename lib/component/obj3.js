...
const Obj3 = {
  properties: {
	...
	affines: undefined,  // elements are same as 'transform', but used by xtweener, and mart4 is used for combined results; default must be undefined, created by XTweener
	combined: undefined, // affines combinatiion, used as tweeing buffer
	invisible: false,
	uniforms: {}
  }
