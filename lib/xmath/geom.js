...
export default class geom {
	...
	static generateWayxz(paths, y0, origin, style, angleEpsilon) {
		...
		pathGeometry.setAttribute("a_pos", new THREE.Float32BufferAttribute(path, 3));
	 ...
	 * @function
	 */
	static getWayPointAt(pointBuffer, points32, t) {
		var point = pointBuffer || new Vector3();
	...
	static hexatile(r) {
		// √3/2 * r
		const r32 = Math.sqrt(3) * 0.5 * (r || 1);
		const r05 = (r || 1) * 0.5;
		return {vert: [[  0,  -r ], [r32, -r05], [r32, r05], [ 0,    r ], [-r32, r05], [-r32, -r05]],
				norm: [[r05, -r32], [  r,   0 ], [r05, r32], [-r05, r32], [ -r,   0 ], [-r05, -r32]]};
	}
}
