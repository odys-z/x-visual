...
export default class geom {
	 ...
	 *
	 * Reference: <a href='https://www.mathworks.com/matlabcentral/answers/89665-generating-an-array-of-hexagonal-shape-pattern'>
	 * mathworks: Generating an Array of Hexagonal Shape Pattern</a>
	 * @param {array} cell 2d position, in epsg 3857
	 * @param {number} radius
	 * @param {number} height
	 * @param {array} geoCentre 2d position, in epsg 3857
	 * @param {number} scale
	 * @return {array} [cell-vertices-array], each vertices is an array of [x, y, z]
	 * @member xgeom.hexacylinder3857
	 * @function
	 */
	static hexacylinder3857(cell, radius, height, geoCentre, scale) {
	}
}
