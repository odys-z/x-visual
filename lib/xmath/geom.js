...
export default class geom {
	 ...
	 * @param {object} style {halfW: number}
	 */
	static generateWayxz(path, y0, style) {
		const halfW = style ? style.halfW || 10 : 10;
		...
		pathGeometry.setAttribute("geoDir", new THREE.Float32BufferAttribute(dirs, 3));
