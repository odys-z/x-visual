...
export default class ChartGrid {
	...
	constructor(chart) {
		...
		/**Grid bounds
		 * @member ChartGrid#grid
		 * @property {array<int>} grid - grid bounds, [w, h, d]
		 */
		this.grid = g;

		/**Grid center index.
		 * @member ChartGrid#cent
	...
	// TODO FIXME
	// TODO FIXME This can only apply to sankey (parallel coords).
	// TODO FIXME
	 ...
	 * @param {array|number} v value in grid
	 * @return {array|number} value in world
	 * @member ChartGrid#space
	 * @function
	 */
	space(v) {
		if (Array.isArray(v)) {
