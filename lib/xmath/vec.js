 ...
 * interpos: {positions, t}, where position is a 2 elements array of vec3<br>
...
mat4.prototype = {
	 ...
	 * @param {object} center
	 * @return {mat4} this
	 * @member mat4#appAfine
	 */
    appAfine: function(affine, center) {
        if (affine.translate) {
			...
			affine.vec3 = affine.interpos.positions[0].mul(1 - t);
            var t =  affine.vec3.add( affine.interpos.positions[1].mul(t) );
