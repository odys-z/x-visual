...
const _m4 = new mat4();	 // buffer

mat4.prototype = {
	js: function() {
		return new THREE.Matrix4().set(this.m);
	},
	 ...
	 * @param {mat4} matrix
	 * @return {mat4} this */
	mulrigth: function(matrix) {
		this.m = mat4.mul(this, matrix).m;
		return this;
	},

	/**Multiply by matrix to the left
	 * @param {mat4} matrix
	 * @return {mat4} this */
	mul: function(matrix) {
	...
	apply: function(affine) {
		if (affine.translate) {
			var t = affine.translate;
			this.mul(mat4.translate(this, t[0], t[1], t[2]), _m4);
		}
		if (affine.rotate) {
...

{
	mat4.js = function(mat4js) {
		if (mat4js instanceof THREE.Matrix4)
        	return new THREE.Matrix4().set(mat4js.clone());
	 ...
	 */
	mat4.combine = function(affines) {
		if (affines && affines.length > 0) {
			// var m4  = affines[0] instanceof mat4 ? mat4(affines[0]) : mat4.of(affines[0]);
			var m4  = mat4.of(affines[0]);
			for (var ax = 1; ax < affines.length; ax++)
				m4.apply(affines[ax]);
			return m4;
		}
	...
	mat4.of = function(affine) {
		return affine instanceof mat4 ? affine : new mat4().apply(affine);
	}
