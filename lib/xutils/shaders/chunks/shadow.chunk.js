export const shadow120 = {
  ...
  setShadowCoords: (n_light) => {return `
    out vec4 vDirectionalShadowCoord[ ${n_light} ];
  ...
  setVpDirShadowcoord: `
    out vec4 vP_DirShadowCoord;
    void setVpDirShadowcoord(mat4 shadowMat, vec4 p4) {
        vP_DirShadowCoord = shadowMat * p4;
    }
  `,
  },
  ...
  vPShadow: `in vec4 vP_DirShadowCoord;
    float vPShadow() {
        DirLight dirLit = directionalLights[0];
    	...
    	return getShadow( directionalShadowMap[ 0 ],
            dirLightShadow.shadowMapSize, dirLightShadow.shadowBias,
            dirLightShadow.shadowRadius, vP_DirShadowCoord );
		// return abs(vP_DirShadowCoord.x);
	}`,
  }
}
