...
export const glConfig = {
  ...
  ks: '(0.3)',   // Specular reflection coefficient, e.g. 1.0,
...
export const glx = {
  ...
  vec4 phongLight(vec3 N, vec3 L, vec4 worldpos,
    ...
    vec2 lambershine = lambertShine(normalize(N), normalize(L), vertPos, shininess);
