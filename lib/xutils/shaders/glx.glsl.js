...
const glx = {
  ...
  bitTrue: `
	...
	/** mix color a &amp; b<br>
	 * Colore can be genType
	 * @param {MixMode} mode
	 */
	mixColorT: (mode) => { let m =
		(mode === MixMode.additive ?
		// FIXME or cola + colb * t, with tone map?
	 ...
	 *
	 * <p>Note:</p>
	 * This function use 'normalMatrix' as global uniform, which stands for
	 ...
	 *
	 */
	revertNormal: (flipping, instancing) => {
		let flp = flipping ? 'n = -n' : '';
