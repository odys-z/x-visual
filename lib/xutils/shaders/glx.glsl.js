...
export const glConfig = {
  ...
  ka: '(1.0)',   // Ambient reflection coefficient, e.g. 1.0,
  kd: '(1.0)',   // Diffuse reflection coefficient, e.g. 0.4,
  ks: '(1.0)',   // Specular reflection coefficient, e.g. 1.0,
...
export const glx = {
  ...
  /**Chenge intensity to mix argument t = :
  ...
  vec4 phongLight(vec3 N, vec3 lightpos, vec4 worldpos,
    ...
    vec2 lambershine = lambertShine(N, L, vertPos, shininess);
