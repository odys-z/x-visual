...
function uniPhongs(light, uniforms = {}, paras = {}) {
	uniforms.u_shininess = {
		value: paras.shininess ||
			(uniforms.u_shininess ? uniforms.u_shininess.value : 1)
	};
	uniforms.u_specularColor = {
		value: paras.shineColor ? new THREE.Vector3(...paras.shineColor) : new THREE.Vector3(1., 1., 1.)
	};

	uniforms.u_ambientColor = {
		value: new THREE.Vector3(...
			(light.ambient || [0, 0, 0]))
	};

	uniforms.u_lightPos = {
		value: new THREE.Vector3(...(light.position || [1, 1, 1]))
	};

	uniforms.u_lightIntensity = {
		value: light.intensity === undefined ?
			1 : light.intensity
	};

	uniforms.u_color = {
		value: new THREE.Vector4(...light.diffuse)
	};
...
//texPrism.prototype.initUniform = uniPhongs;
//texPrism.prototype.updateUniform = updatePhongs;
...
//xyzLayer2.prototype.initUniform = uniPhongs;
//xyzLayer2.prototype.updateUniform = updatePhongs;
