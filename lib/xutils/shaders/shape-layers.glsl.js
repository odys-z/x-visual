...
export function xyzLayer2(vparas) {
 ...
 vertexShader: `
  ...
  void main() {
    ...
    vec2 lambershine = lambertShine(N, L, vertPos, 1.);
    // vColor = vec4(Ka * u_color.xyz + // u_ambientColor +
    //               Kd * lambershine.s * u_color + // diffuseColor +
    //               Ks * lambershine.t * u_specularColor, u_alpha);
    va *= u_alpha;
	vColor = vec4(Ka * u_color.xyz
