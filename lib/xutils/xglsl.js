...
import * as THREE from '../../packages/three/three.module-MRTSupport';
	...
	import {_hBlur} from './shaders/_filters.glsl'
	...
	import {ssao, u_ssao} from './shaders/ssao.glsl'
	...
	import {testXFrag, testXDepth} from './shaders/testxfrag.glsl'
...
export function xvShader(flag, vparas = {}, obj3 = {}, debug) {
	...
	switch (flag) {
		...
		case ShaderFlag._hBlur:
			s = _hBlur(vparas, debug);
			break;
