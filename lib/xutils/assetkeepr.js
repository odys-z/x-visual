...
// import * as html2canvas from '../../packages/misc/html2canvas.esm.js';
...
export default class AssetKeepr {
	...
	static initCanvtex(cmpCanv) {
		...
		html2canvas(h5).then( function(canvas) {
			var drawingContext = canvas.getContext( '2d' );
			cmpCanv.canvas = canvas;
			cmpCanv.tex = new THREE.CanvasTexture(canvas);
