...
export default class XWorld {
	 ...
	 * @property {object} xlight - set light parameters can applied to objects,
	 * where xlight.hemisphere = THREE.HemisphereLight
	...
	/**@property {XMaterials} xlight - light, with property "options"
	 * @member XWorld#xlight */
