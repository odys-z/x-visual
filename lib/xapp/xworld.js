...
import Lighting from '../sys/light'
...
import AffineCombiner3 from '../sys/tween/affinecombiner3'
...
export default class XWorld {
	...
	/**https://stackoverflow.com/questions/19531845/can-js-have-getters-and-setters-methods-named-same-as-property
	 * @property {THREE.HemisphereLight} xlight - set light parameters can applied to objects */
	set xlight(p) {
		this.lighting.set(p);
		return this;
	}
	...
	startUpdate() {
		...
		ecs.addSystem('render', sys3);
			...
			this.lighting = new Lighting(ecs, x);
			ecs.addSystem('render', this.lighting);
