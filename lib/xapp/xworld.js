...
import XTweener2 from '../sys/tween/xtweener2'
import AffineCombiner2 from '../sys/tween/affinecombiner2'
...
export default class XWorld {
	...
	startUpdate() {
		...
		ecs.addSystem('tween', new XTweener2(ecs, x, resolvingStarts));
		ecs.addSystem('tween', new AffineCombiner2(ecs, x));
